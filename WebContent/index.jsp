...
<body  style="background: url('${pageContext.request.contextPath}/public/img/coffeeshop.jpg') no-repeat 0 0; background-size:cover;">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
		...
		<div class="col-md-10">
			<h1 class="m-b-20"><strong>Welcome To Coffee Shop</strong></h1>
